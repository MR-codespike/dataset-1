...
# ============================================================================
# STEP 5: THE REAL TEST — regression suite
# ============================================================================
...
reg_labels = [l for t, l in regression_cases]

reg_embeddings = embed_model.encode(reg_texts, normalize_embeddings=True)
reg_predictions = classifier.predict(reg_embeddings)

correct = 0
failures = []
for text, expected, predicted in zip(reg_texts, reg_labels, reg_predictions):
